...
Details on the code chunk can be found in section 1.3.4. After splitting the words in `type` column, a physical file for clean mc2_nodes is saved in the format of R **rds**. Instead of "event", we will replace the column naming as "Entity" for mc2_nodes.
