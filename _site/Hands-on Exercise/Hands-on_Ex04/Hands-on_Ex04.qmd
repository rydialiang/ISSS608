...
This hands-on exercise consists of Chapter 10 to 12 of R4VA.
...
[**ggstatsplot**](https://indrajeetpatil.github.io/ggstatsplot/) ![](https://r4va.netlify.app/chap10/img/image1.jpg){width="48"} is an extension of [**ggplot2**](https://ggplot2.tidyverse.org/) package for creating graphics with details from statistical tests included in the information-rich plots themselves.
