...
There are only 4 records of visits through the OVLS to Don Limpet, once in Mar and Jun, for about 1.5 to 2hrs each, and another 2 in Aug, for about 1.25 to 1.75 hrs each. Thire record is high inconguent to the growing number of Sockfish that are found in the delivery report from May onwards. 
